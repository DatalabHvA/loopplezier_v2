...
st_folium(
    ...
    width=1000, height=700, returned_objects=[], key="home_map",
)
if route:
...
if pareto_df is not None and len(pareto_df) > 0:
    ...
    st.caption("Klik op een punt in de grafiek om die alternatieve route (ook met een lagere score, maar op de Pareto-front) op de kaart te zien.")
